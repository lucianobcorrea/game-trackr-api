...
class IgdbGameService
{
    ...
    /**
     * Global game search without date/release filters.
     *
    ...
    public function searchGames(
        ...
        $whereClause = $this->buildWhereClause(
            baseCondition: 'name != null & cover != null',
            search: $search,
            platform: $platform
        );

        $query = 'fields name, slug, summary, first_release_date, total_rating, rating, total_rating_count, cover.url, platforms.name, platforms.slug; '
            ."{$whereClause} "
